...
//    Vasya will not have the right bills to give 75 dollars of change (you can't make two bills of 25 from one of 50)
    ...
    public static String Tickets(int[] peopleInLine) {
        ...
        for (int value : peopleInLine) {
            ...
            if (peopleInLine[0] == 50 || peopleInLine[0] == 100 || peopleInLine[1] == 100
                    || peopleInLine[2] == 100) return "NO";
            if (value == 25) note25++;
            else if (value == 50) {
                note50++;
                note25--;
                if (note25 < 0) return "NO";
            } else if (value == 100 && note25 > 0 && note50 > 0) {
                note25--;
                note50--;
            } else if (value == 100 && note25 >= 3) note25 -= 3;
            else return "NO";
        }
        return "YES";
    }
